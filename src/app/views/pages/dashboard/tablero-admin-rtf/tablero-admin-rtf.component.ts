...
import { UsuarioToken } from 'src/app/core/GenericaInterfaz';
...
@Component({
  ...
  templateUrl: './tablero-admin-rtf.component.html',
  styleUrls: ['./tablero-admin-rtf.component.css'],
})
export class TableroAdminRtfComponent implements OnInit {
  /**
   * Apex chart
   */
