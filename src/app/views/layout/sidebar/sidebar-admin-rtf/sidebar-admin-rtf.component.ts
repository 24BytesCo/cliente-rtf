...
import { MENU, MENU_ADMIN_RTF } from '../menu';

@Component({
  selector: 'app-sidebar-admin-rtf',
  templateUrl: './sidebar-admin-rtf.component.html',
  styleUrls: ['./sidebar-admin-rtf.component.css'],
})
export class SidebarAdminRtfComponent implements OnInit {
